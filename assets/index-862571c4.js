 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sT=new Ve(W.comparator);function On(){return sT}const s_=new Ve(W.comparator);function ai(...t){let e=s_;for(const n of t)e=e.insert(n.key,n);return e}function r_(t){let e=s_;return t.forEach((n,s)=>e=e.insert(n,s.overlayedDocument)),e}function Rs(){return gi()}function i_(){return gi()}function gi(){return new Ur(t=>t.toString(),(t,e)=>t.isEqual(e))}const rT=new Ve(W.comparator),iT=new wt(W.comparator);function he(...t){let e=iT;for(const n of t)e=e.add(n);return e}const oT=new wt(we);function aT(){return oT}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function o_(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:ma(e)?"-0":e}}function a_(t){return{integerValue:""+t}}function cT(t,e){return Vb(e)?a_(e):o_(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class VT{constructor(e){this.le=e}}function BT(t){const e=xT({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?ql(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HT{constructor(){this.changes=new Ur(e=>e.toString(),(e,n)=>e.isEqual(n)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,n){this.assertNotApplied(),this.changes.set(e,gt.newInvalidDocument(e).setReadTime(n))}getEntry(e,n){this.assertNotApplied();const s=this.changes.get(n);return s!==void 0?P.resolve(s):this.getFromCache(e,n)}getEntries(e,n){return this.getAllFromCache(e,n)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dc(t){return new CT(t,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class v1{constructor(e,n,s,r,i){this.localStore=e,this.datastore=n,this.asyncQueue=s,this.remoteSyncer={},this.Tu=[],this.Eu=new Map,this.Au=new Set,this.Ru=[],this.vu=i,this.vu.Jr(o=>{s.enqueueAndForget(async()=>{Ks(this)&&(H("RemoteStore","Restarting streams for network reachability change."),await async function(a){const c=oe(a);c.Au.add(4),await ao(c),c.Pu.set("Unknown"),c.Au.delete(4),await fc(c)}(this))})}),this.Pu=new y1(s,r)}}async function fc(t){if(Ks(t))for(const e of t.Ru)await e(!0)}async function ao(t){for(const e of t.Ru)await e(!1)}function A_(t,e){const n=oe(t);n.Eu.has(e.targetId)||(n.Eu.set(e.targetId,e),fh(n)?dh(n):Fr(n).Uo()&&hh(n,e))}function R_(t,e){const n=oe(t),s=Fr(n);n.Eu.delete(e),s.Uo()&&k_(n,e),n.Eu.size===0&&(s.Uo()?s.Qo():Ks(n)&&n.Pu.set("Unknown"))}function hh(t,e){if(t.bu.Lt(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(re.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}Fr(t).nu(e)}function k_(t,e){t.bu.Lt(e),Fr(t).su(e)}function dh(t){t.bu=new IT({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),he:e=>t.Eu.get(e)||null,oe:()=>t.datastore.serializer.databaseId}),Fr(t).start(),t.Pu.mu()}function fh(t){return Ks(t)&&!Fr(t).qo()&&t.Eu.size>0}function Ks(t){return oe(t).Au.size===0}function N_(t){t.bu=void 0}async function w1(t){t.Eu.forEach((e,n)=>{hh(t,e)})}async function E1(t,e){N_(t),fh(t)?(t.Pu.pu(e),dh(t)):t.Pu.set("Unknown")}async function I1(t,e,n){if(t.Pu.set("Online"),e instanceof m_&&e.state===2&&e.cause)try{await async function(s,r){const i=r.cause;for(const o of r.targetIds)s.Eu.has(o)&&(await s.remoteSyncer.rejectListen(o,i),s.Eu.delete(o),s.bu.removeTarget(o))}(t,e)}catch(s){H("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),s),await Ea(t,s)}else if(e instanceof Ko?t.bu.Wt(e):e instanceof g_?t.bu.ee(e):t.bu.Yt(e),!n.isEqual(re.min()))try{const s=await T_(t.localStore);n.compareTo(s)>=0&&await function(r,i){const o=r.bu.ue(i);return o.targetChanges.forEach((a,c)=>{if(a.resumeToken.approximateByteSize()>0){const l=r.Eu.get(c);l&&r.Eu.set(c,l.withResumeToken(a.resumeToken,i))}}),o.targetMismatches.forEach((a,c)=>{const l=r.Eu.get(a);if(!l)return;r.Eu.set(a,l.withResumeToken(It.EMPTY_BYTE_STRING,l.snapshotVersion)),k_(r,a);const u=new Xn(l.target,a,c,l.sequenceNumber);hh(r,u)}),r.remoteSyncer.applyRemoteEvent(o)}(t,n)}catch(s){H("RemoteStore","Failed to raise snapshot:",s),await Ea(t,s)}}async function Ea(t,e,n){if(!so(e))throw e;t.Au.add(1),await ao(t),t.Pu.set("Offline"),n||(n=()=>T_(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{H("RemoteStore","Retrying IndexedDB access"),await n(),t.Au.delete(1),await fc(t)})}function P_(t,e){return e().catch(n=>Ea(t,n,e))}async function pc(t){const e=oe(t),n=cs(e);let s=e.Tu.length>0?e.Tu[e.Tu.length-1].batchId:-1;for(;b1(e);)try{const r=await a1(e.localStore,s);if(r===null){e.Tu.length===0&&n.Qo();break}s=r.batchId,T1(e,r)}catch(r){await Ea(e,r)}D_(e)&&O_(e)}function b1(t){return Ks(t)&&t.Tu.length<10}function T1(t,e){t.Tu.push(e);const n=cs(t);n.Uo()&&n.ru&&n.ou(e.mutations)}function D_(t){return Ks(t)&&!cs(t).qo()&&t.Tu.length>0}function O_(t){cs(t).start()}async function S1(t){cs(t).au()}async function C1(t){const e=cs(t);for(const n of t.Tu)e.ou(n.mutations)}async function A1(t,e,n){const s=t.Tu.shift(),r=rh.from(s,e,n);await P_(t,()=>t.remoteSyncer.applySuccessfulWrite(r)),await pc(t)}async function R1(t,e){e&&cs(t).ru&&await async function(n,s){if(r=s.code,vT(r)&&r!==A.ABORTED){const i=n.Tu.shift();cs(n).Go(),await P_(n,()=>n.remoteSyncer.rejectFailedWrite(i.batchId,s)),await pc(n)}var r}(t,e),D_(t)&&O_(t)}async function If(t,e){const n=oe(t);n.asyncQueue.verifyOperationInProgress(),H("RemoteStore","RemoteStore received new credentials");const s=Ks(n);n.Au.add(3),await ao(n),s&&n.Pu.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.Au.delete(3),await fc(n)}async function k1(t,e){const n=oe(t);e?(n.Au.delete(2),await fc(n)):e||(n.Au.add(2),await ao(n),n.Pu.set("Unknown"))}function Fr(t){return t.Vu||(t.Vu=function(e,n,s){const r=oe(e);return r.lu(),new g1(n,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,s)}(t.datastore,t.asyncQueue,{oo:w1.bind(null,t),co:E1.bind(null,t),eu:I1.bind(null,t)}),t.Ru.push(async e=>{e?(t.Vu.Go(),fh(t)?dh(t):t.Pu.set("Unknown")):(await t.Vu.stop(),N_(t))})),t.Vu}function cs(t){return t.Su||(t.Su=function(e,n,s){const r=oe(e);return r.lu(),new m1(n,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,s)}(t.datastore,t.asyncQueue,{oo:S1.bind(null,t),co:R1.bind(null,t),cu:C1.bind(null,t),uu:A1.bind(null,t)}),t.Ru.push(async e=>{e?(t.Su.Go(),await pc(t)):(await t.Su.stop(),t.Tu.length>0&&(H("RemoteStore",`Stopping write stream with ${t.Tu.length} pending writes`),t.Tu=[]))})),t.Su}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class N1{constructor(){this.xu=void 0,this.listeners=[]}}class P1{constructor(){this.queries=new Ur(e=>t_(e),ac),this.onlineState="Unknown",this.Nu=new Set}}async function D1(t,e){const n=oe(t),s=e.query;let r=!1,i=n.queries.get(s);if(i||(r=!0,i=new N1),r)try{i.xu=await n.onListen(s)}catch(o){const a=gh(o,`Initialization of query '${Hl(e.query)}' failed`);return void e.onError(a)}n.queries.set(s,i),i.listeners.push(e),e.ku(n.onlineState),i.xu&&e.Mu(i.xu)&&mh(n)}async function O1(t,e){const n=oe(t),s=e.query;let r=!1;const i=n.queries.get(s);if(i){const o=i.listeners.indexOf(e);o>=0&&(i.listeners.splice(o,1),r=i.listeners.length===0)}if(r)return n.queries.delete(s),n.onUnlisten(s)}function x1(t,e){const n=oe(t);let s=!1;for(const r of e){const i=r.query,o=n.queries.get(i);if(o){for(const a of o.listeners)a.Mu(r)&&(s=!0);o.xu=r}}s&&mh(n)}function M1(t,e,n){const s=oe(t),r=s.queries.get(e);if(r)for(const i of r.listeners)i.onError(n);s.queries.delete(e)}function mh(t){t.Nu.forEach(e=>{e.next()})}class L1{constructor(e,n,s){this.query=e,this.Ou=n,this.$u=!1,this.Fu=null,this.onlineState="Unknown",this.options=s||{}}Mu(e){if(!this.options.includeMetadataChanges){const s=[];for(const r of e.docChanges)r.type!==3&&s.push(r);e=new Sr(e.query,e.docs,e.oldDocs,s,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let n=!1;return this.$u?this.Bu(e)&&(this.Ou.next(e),n=!0):this.Lu(e,this.onlineState)&&(this.qu(e),n=!0),this.Fu=e,n}onError(e){this.Ou.error(e)}ku(e){this.onlineState=e;let n=!1;return this.Fu&&!this.$u&&this.Lu(this.Fu,e)&&(this.qu(this.Fu),n=!0),n}Lu(e,n){if(!e.fromCache)return!0;const s=n!=="Offline";return(!this.options.Uu||!s)&&(!e.docs.isEmpty()||e.hasCachedResults||n==="Offline")}Bu(e){if(e.docChanges.length>0)return!0;const n=this.Fu&&this.Fu.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!n)&&this.options.includeMetadataChanges===!0}qu(e){e=Sr.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.$u=!0,this.Ou.next(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
